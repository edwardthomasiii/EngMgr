...
namespace EngMgr
{
    public partial class DrafterControl : System.Web.UI.Page
    {
        ...
        protected void ExportToExcelBtn_Click(object sender, EventArgs e)
        {
            ...
            Response.AppendHeader("content-disposition", "attachment; filename=DrafterControl.xls");
            ...
            DrafterControlGridView.RenderControl(htmltextwriter);
        ...
        protected void ExportToWordBtn_Click(object sender, EventArgs e)
        {
            ...
            Response.ClearContent();
            //defines the function to apply i.e. download etc...
            Response.AppendHeader("content-disposition", "attachment; filename=DrafterControl.doc");
            //defines the action type you are doing  i.e. downloading etc
