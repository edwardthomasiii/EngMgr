...
namespace EngMgr
{
    public partial class DrafterDefault : System.Web.UI.Page
    {
        ...
        protected void ExportToExcelBtn_Click(object sender, EventArgs e)
        {
            ...
            Response.AppendHeader("content-disposition", "attachment; filename=DrafterDefault.xls");
            ...
            DrafterDefaultGridView.RenderControl(htmltextwriter);
        ...
        protected void ExportToWordBtn_Click(object sender, EventArgs e)
        {
            ...
            Response.ClearContent();
            //defines the function to apply i.e. download etc...
            Response.AppendHeader("content-disposition", "attachment; filename=DrafterDefault.doc");
            //defines the action type you are doing  i.e. downloading etc
