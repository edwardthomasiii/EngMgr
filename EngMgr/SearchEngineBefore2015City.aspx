<%@ Page Title="" Language="C#" MasterPageFile="~/SearchEngine.Master" AutoEventWireup="true" CodeBehind="SearchEngineBefore2015City.aspx.cs" Inherits="EngMgr.SearchEngineBefore2015City" EnableEventValidation="false" %>
   ...
   <asp:Panel ID="SearchPnl" runat="server" Font-Bold="True" Font-Names="Tahoma" Font-Size="X-Large" Width="100%">
    ...
    <table class="auto-style11">
        ...
        <tr>
            <td>
                Equipment<br />
                <asp:SqlDataSource ID="cityds" runat="server" ConnectionString="<%$ ConnectionStrings:maincs %>" SelectCommand="SELECT DISTINCT [City/State] AS column1 FROM [oldjobs]"></asp:SqlDataSource>
            </td>
            <td>
                Company<br />
            </td>
            <td>
                City/Location<br />
                <ajaxToolkit:ComboBox ID="cityddl" runat="server" AutoPostBack="True" DataSourceID="cityds" DataTextField="column1" DataValueField="column1" MaxLength="0" style="display: inline;">
    ...
    <asp:SqlDataSource ID="eng2wadeds" runat="server" ConnectionString="<%$ ConnectionStrings:maincs %>" SelectCommand="SELECT [MTC Job No] AS MTC_Job_No, Customer, [City/State] AS column1, [Ship Date] AS Ship_Date, [G A  Dwg] AS G_A_Dwg, [Install Dwg] AS Install_Dwg, [Sales Dwg] AS Sales_Dwg, [TA Dwg] AS TA_Dwg, [HY_PN Dwg] AS HY_PN_Dwg, [Hy Dwg] AS Hy_Dwg, [Pn Dwg] AS Pn_Dwg, [Elec Dwg] AS Elec_Dwg, [Equipment Type] AS Equipment_Type, [EBatt Labels] AS EBatt_Labels, [EL_HY Dwg] AS EL_HY_Dwg, [Serial Number] FROM oldjobs WHERE ([City/State] like '%'+ @city +'%')">
        <SelectParameters>
            <asp:ControlParameter ControlID="cityddl" Name="city" PropertyName="SelectedValue" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:GridView ID="GridViewwade" runat="server" AutoGenerateColumns="False" DataSourceID="eng2wadeds" CellPadding="4" HorizontalAlign="Center" ShowHeaderWhenEmpty="True" Width="100%" ForeColor="#333333" GridLines="None" AllowSorting="True">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Serial Number" HeaderText="Serial_Number" SortExpression="Serial_Number" />
