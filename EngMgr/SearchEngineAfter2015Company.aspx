<%@ Page Title="" Language="C#" MasterPageFile="~/SearchEngine.Master" AutoEventWireup="true" CodeBehind="SearchEngineAfter2015Company.aspx.cs" Inherits="EngMgr.SearchEngineAfter2015Company" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="Panel2" runat="server">
        <div class="auto-style8">
            <table class="auto-style11">
                <tr>
                    <td>
                        <asp:Button ID="esearchbtn" runat="server" BackColor="Yellow" BorderColor="Orange" BorderStyle="None" BorderWidth="10px" Font-Bold="True" Font-Names="Calibri" Font-Size="X-Large" PostBackUrl="~/SearchEngineAfter2015Equipment.aspx" Text="Equipment Search" />
                    </td>
                    <td>
                    ...
                    <td>
                        <asp:Button ID="Citsrchbtn" runat="server" BackColor="Yellow" BorderColor="Orange" BorderStyle="None" BorderWidth="10px" Font-Bold="True" Font-Names="Calibri" Font-Size="X-Large" Text="City/Location Search" PostBackUrl="~/SearchEngineAfter2015City.aspx" />
                    </td>
                    <td>
                ...
                <tr>
                    <td>Equipment<br />
                        <asp:SqlDataSource ID="itemds" runat="server" ConnectionString="<%$ ConnectionStrings:maincs %>" SelectCommand="SELECT DISTINCT Company FROM JobEngine"></asp:SqlDataSource>
                    </td>
                    <td>Company<br /> 
                        <ajaxToolkit:ComboBox ID="snddl" runat="server" AutoPostBack="True" DataSourceID="itemds" DataTextField="Company" DataValueField="Company" MaxLength="0" style="display: inline;">
    ...
    <asp:SqlDataSource ID="jobenginesearcher" runat="server" ConnectionString="<%$ ConnectionStrings:maincs %>" SelectCommand="SELECT COnumber, Company, ItemDESCRIPTION, SN, Address, GAdwg, Item, INSTALLdwgnum, SYSPROPdwgnum, TAdwgnum, ELdwgnum, HYdwgnum, PNdwgnum, ShipDate FROM JobEngine WHERE (Company = @item)">
        <SelectParameters>
            <asp:ControlParameter ControlID="snddl" Name="item" PropertyName="SelectedValue" />
        </SelectParameters>
    </asp:SqlDataSource>
    <br />
    </asp:Content>
