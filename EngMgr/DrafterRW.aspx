<%@ Page Title="" Language="C#" MasterPageFile="~/Drafter.Master" AutoEventWireup="true" CodeBehind="DrafterRW.aspx.cs" Inherits="EngMgr.DrafterRW" EnableEventValidation="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    ...
    <asp:SqlDataSource ID="BWds" runat="server" ConnectionString="<%$ ConnectionStrings:maincs %>" SelectCommand="SELECT ID, COnumber, Company, Item, DateRecvd, ShipDate, GAESTRELDATE, GAdwg, GACompDate, FirstAppDate, TAESTRELDATE, TAdwgnum, TACompDAte, TARELtoPlanDate FROM JobEngine WHERE (Status = N'Not Shipped') AND (TACompDAte IS NULL) AND (RW = 1) ORDER BY ShipDate, Company, COnumber"></asp:SqlDataSource>
</asp:Content>
