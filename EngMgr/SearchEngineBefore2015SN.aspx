<%@ Page Title="" Language="C#" MasterPageFile="~/SearchEngine.Master" AutoEventWireup="true" CodeBehind="SearchEngineBefore2015SN.aspx.cs" Inherits="EngMgr.SearchEngineBefore2015SN" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="auto-style11">
        ...
        <tr>
            <td>
                Equipment<br />
                <asp:SqlDataSource ID="cityds" runat="server" ConnectionString="<%$ ConnectionStrings:maincs %>" SelectCommand="SELECT DISTINCT [Serial Number] AS Serial_Number FROM [oldjobs]"></asp:SqlDataSource>
            </td>
            <td>
                Company<br />
            </td>
            ...
            <td>
                Serial Number<br />
                <ajaxToolkit:ComboBox ID="snddl" runat="server" AutoPostBack="True" DataSourceID="cityds" DataTextField="Serial_Number" DataValueField="Serial_Number" MaxLength="0" style="display: inline;">
    ...
    <asp:Button ID="excelexporter" runat="server" BackColor="Orange" BorderColor="Brown" BorderStyle="Outset" BorderWidth="10px" Text="Export to Excel" OnClick="excelexporter_Click" />
    <asp:SqlDataSource ID="eng2wadeds" runat="server" ConnectionString="<%$ ConnectionStrings:maincs %>" SelectCommand="SELECT [MTC Job No] AS MTC_Job_No, [Customer], [Equipment Type] AS Equipment_Type, [Serial Number] AS Serial_Number, [City/State] AS column1, [Ship Date] AS Ship_Date, [G A  Dwg] AS G_A_Dwg, [Install Dwg] AS Install_Dwg, [Sales Dwg] AS Sales_Dwg, [EL_HY Dwg] AS EL_HY_Dwg, [TA Dwg] AS TA_Dwg, [HY_PN Dwg] AS HY_PN_Dwg, [Elec Dwg] AS Elec_Dwg, [Pn Dwg] AS Pn_Dwg, [Hy Dwg] AS Hy_Dwg FROM [oldjobs] WHERE ([Serial Number] LIKE '%' + @Serial_Number + '%')">
        <SelectParameters>
            <asp:ControlParameter ControlID="snddl" Name="Serial_Number" PropertyName="SelectedValue" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
