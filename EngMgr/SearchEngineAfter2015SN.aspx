<%@ Page Title="" Language="C#" MasterPageFile="~/SearchEngine.Master" AutoEventWireup="true" CodeBehind="SearchEngineAfter2015SN.aspx.cs" Inherits="EngMgr.SearchEngineAfter2015SN" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="auto-style2">
            <table class="auto-style11">
                ...
                <tr>
                    <td>Equipment<br />
                        <br />
                        <asp:SqlDataSource ID="itemds" runat="server" ConnectionString="<%$ ConnectionStrings:maincs %>" SelectCommand="SELECT DISTINCT [SN] FROM [JobEngine]"></asp:SqlDataSource>
                    </td>
                    <td>Company<br /> </td>
                    <td>City/Location</td>
                    <td>Serial Number<br />
                        <ajaxToolkit:ComboBox ID="cityddl" runat="server" AutoPostBack="True" DataSourceID="itemds" DataTextField="SN" DataValueField="SN" MaxLength="0" style="display: inline;">
    ...
    <asp:SqlDataSource ID="jobenginesearcher" runat="server" ConnectionString="<%$ ConnectionStrings:maincs %>" SelectCommand="SELECT [COnumber], [Company], [Item], [INSTALLdwgnum], [ItemDESCRIPTION], [ShipDate], [SYSPROPdwgnum], [SN], [Address], [GAdwg], [TAdwgnum], [ELdwgnum], [HYdwgnum], [PNdwgnum] FROM [JobEngine] WHERE ([SN] LIKE '%' + @SN + '%')">
        <SelectParameters>
            <asp:ControlParameter ControlID="cityddl" Name="SN" PropertyName="SelectedValue" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    <br />
    </asp:Content>
