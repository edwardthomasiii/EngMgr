<%@ Page Title="" Language="C#" MasterPageFile="~/SearchEngine.Master" AutoEventWireup="true" CodeBehind="SearchEngineAfter2015Equipment.aspx.cs" Inherits="EngMgr.SearchEngineAfter2015Equipment" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="Panel2" runat="server">
        <div class="auto-style8">
            <table class="auto-style11">
                ...
                <tr>
                    <td>Equipment<br />
                        <ajaxToolkit:ComboBox ID="snddl" runat="server" AutoPostBack="True" DataSourceID="itemds" DataTextField="Item" DataValueField="Item" MaxLength="0" style="display: inline;">
                        </ajaxToolkit:ComboBox>
                        <br />
                        <asp:SqlDataSource ID="itemds" runat="server" ConnectionString="<%$ ConnectionStrings:maincs %>" SelectCommand="SELECT DISTINCT Item FROM JobEngine"></asp:SqlDataSource>
                    </td>
                    <td>Company<br /> </td>
                    <td>City/Location</td>
    ...
    <asp:SqlDataSource ID="jobenginesearcher" runat="server" ConnectionString="<%$ ConnectionStrings:maincs %>" SelectCommand="SELECT [COnumber], [Company], [ItemDESCRIPTION], [SN], [Address], [GAdwg], [Item], [INSTALLdwgnum], [SYSPROPdwgnum], [TAdwgnum], [ELdwgnum], [HYdwgnum], [PNdwgnum], [ShipDate] FROM [JobEngine] WHERE ([Item] = @Item)">
        <SelectParameters>
            <asp:ControlParameter ControlID="snddl" Name="Item" PropertyName="SelectedValue" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    <br />
    </asp:Content>
