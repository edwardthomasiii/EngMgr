...
namespace EngMgr
{
    public partial class EngineerRG : System.Web.UI.Page
    {
        ...
        protected void ExcelExportButton_Click(object sender, EventArgs e)
        {
            ...
            Response.AppendHeader("content-disposition", "attachment; filename=Rodney_Assignment.xls");
            ...
            RAGridView.RenderControl(htmltextwriter);
        ...
        protected void ExportToWordButton_Click(object sender, EventArgs e)
        {
            ...
            Response.ClearContent();
            //defines the function to apply i.e. download etc...
            Response.AppendHeader("content-disposition", "attachment; filename=Rodney_Assignment.doc");
            //defines the action type you are doing  i.e. downloading etc
