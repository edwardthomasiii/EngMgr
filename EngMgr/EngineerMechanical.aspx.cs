...
namespace EngMgr
{
    public partial class EngineerMechanical : System.Web.UI.Page
    {
        ...
        protected void ExportToExcelBtn_Click(object sender, EventArgs e)
        {
            ...
            Response.AppendHeader("content-disposition", "attachment; filename=EngineerMechanical.xls");
            ...
            EngineerMechanicalGridView.RenderControl(htmltextwriter);
        ...
        protected void ExportToWordBtn_Click(object sender, EventArgs e)
        {
            //clears the content from the metadata
            Response.ClearContent();
            //defines the function to apply i.e. download etc...
            Response.AppendHeader("content-disposition", "attachment; filename=Engineermechanical.doc");
            //defines the action type you are doing  i.e. downloading etc
