<%@ Page Title="" Language="C#" MasterPageFile="~/SearchEngine.Master" AutoEventWireup="true" CodeBehind="SearchEngineAfter2015City.aspx.cs" Inherits="EngMgr.SearchEngineAfter2015City" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="auto-style8">
            <table class="auto-style11">
                ...
                <tr>
                    <td>Equipment<br />
                        <br />
                        <asp:SqlDataSource ID="itemds" runat="server" ConnectionString="<%$ ConnectionStrings:maincs %>" SelectCommand="SELECT DISTINCT Address FROM JobEngine WHERE (NOT (Address IS NULL))"></asp:SqlDataSource>
                    </td>
                    <td>Company<br /> </td>
                    <td>City/Location<br />
                        <ajaxToolkit:ComboBox ID="cityddl" runat="server" AutoPostBack="True" DataSourceID="itemds" DataTextField="Address" DataValueField="Address" MaxLength="0" style="display: inline;">
    ...
    <asp:SqlDataSource ID="jobenginesearcher" runat="server" ConnectionString="<%$ ConnectionStrings:maincs %>" SelectCommand="SELECT COnumber, Company + Address AS Company, Item, INSTALLdwgnum, ItemDESCRIPTION, ShipDate, SYSPROPdwgnum, SN, Address, GAdwg, TAdwgnum, ELdwgnum, HYdwgnum, PNdwgnum FROM JobEngine WHERE (Address LIKE N'%' + @Address + N'%')">
        <SelectParameters>
            <asp:ControlParameter ControlID="cityddl" Name="Address" PropertyName="SelectedValue" />
        </SelectParameters>
    </asp:SqlDataSource>
    <br />
    </asp:Content>
