<%@ Page Title="" Language="C#" MasterPageFile="~/Drafter.Master" AutoEventWireup="true" CodeBehind="DrafterControl.aspx.cs" Inherits="EngMgr.DrafterControl" EnableEventValidation="false"%>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="ExportToWordBtn" runat="server" BackColor="Blue" BorderColor="#3399FF" Font-Bold="True" Font-Names="Tahoma" Font-Size="Large" ForeColor="White" Text="Export To Word" Height="40px" Width="200px" OnClick="ExportToWordBtn_Click" Visible="False" />
    </asp:Panel>
    <br />
