<%@ Page Title="" Language="C#" MasterPageFile="~/Engineer.Master" AutoEventWireup="true" CodeBehind="EngineerControl.aspx.cs" Inherits="EngMgr.EngineerControl" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel1" runat="server" Width="54%" HorizontalAlign="Left">
        &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="ExportToWordButton" runat="server" BackColor="Blue" BorderColor="#3399FF" Font-Bold="True" Font-Names="Tahoma" Font-Size="Large" ForeColor="White" Text="Export To Word" OnClick="ExportToWordButton_Click" Height="40px" Width="200px" Visible="False" />
    </asp:Panel>
    <asp:ScriptManager ID="ScriptManagerEngineerControl" runat="server">
    </asp:ScriptManager>
    <asp:GridView ID="ControlGridView" runat="server" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" CellPadding="4" DataSourceID="ecds" ForeColor="Black" AutoGenerateColumns="False" DataKeyNames="ID" Width="100%">
        <AlternatingRowStyle BackColor="White" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" />
        <Columns>
            <asp:TemplateField ShowHeader="False">
                <EditItemTemplate>
                    <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="True" CommandName="Update" CssClass="auto-style4" Text="Update"></asp:LinkButton>
                    <br />
                    <asp:LinkButton ID="LinkButton2" runat="server" CausesValidation="False" CommandName="Cancel" CssClass="auto-style4" Text="Cancel"></asp:LinkButton>
                </EditItemTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Company" SortExpression="Company">
                ...
                <ItemTemplate>
                    <div class="auto-style3">
                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("Company") %>' Width="300px"></asp:Label>
                        <br />
                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("COnumber", "{0}") %>' Width="200px"></asp:Label>
                    </div>
                </ItemTemplate>
