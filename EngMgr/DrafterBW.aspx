<%@ Page Title="" Language="C#" MasterPageFile="~/Drafter.Master" AutoEventWireup="true" CodeBehind="DrafterBW.aspx.cs" Inherits="EngMgr.DrafterBW" EnableEventValidation="false"%>
...
<asp:SqlDataSource ID="BWds" runat="server" ConnectionString="<%$ ConnectionStrings:maincs %>" SelectCommand="SELECT ID, COnumber, Company, Item, DateRecvd, ShipDate, GAESTRELDATE, GAdwg, GACompDate, FirstAppDate, TAESTRELDATE, TAdwgnum, TACompDAte, TARELtoPlanDate FROM JobEngine WHERE (Status = N'Not Shipped') AND (TACompDAte IS NULL) AND (BW = 1) ORDER BY ShipDate, Company, COnumber"></asp:SqlDataSource>
</asp:Content>
