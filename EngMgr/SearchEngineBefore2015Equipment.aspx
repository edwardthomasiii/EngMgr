<%@ Page Title="" Language="C#" MasterPageFile="~/SearchEngine.Master" AutoEventWireup="true" CodeBehind="SearchEngineBefore2015Equipment.aspx.cs" Inherits="EngMgr.SearchEngineBefore2015Equipment" EnableEventValidation="false" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="auto-style11">
        ...
        <tr>
            <td>
                Equipment&nbsp; <br />
                <asp:SqlDataSource ID="equipmentds" runat="server" ConnectionString="<%$ ConnectionStrings:maincs %>" SelectCommand="SELECT DISTINCT [Equipment Type] AS Equipment_Type FROM [oldjobs] ORDER BY [Equipment Type]"></asp:SqlDataSource>
                <ajaxToolkit:ComboBox ID="ewadeqddl" runat="server" AutoPostBack="True" DataSourceID="equipmentds" DataTextField="Equipment_Type" DataValueField="Equipment_Type" MaxLength="0" style="display: inline;">
    ...
    <asp:SqlDataSource ID="eng2wadeds" runat="server" ConnectionString="<%$ ConnectionStrings:maincs %>" SelectCommand="SELECT DISTINCT [MTC Job No] AS MTC_Job_No, [Customer], [Equipment Type] AS Equipment_Type, [Serial Number] AS Serial_Number, [City/State] AS column1, [Ship Date] AS Ship_Date, [G A  Dwg] AS G_A_Dwg, [Install Dwg] AS Install_Dwg, [Sales Dwg] AS Sales_Dwg, [EL_HY Dwg] AS EL_HY_Dwg, [TA Dwg] AS TA_Dwg, [HY_PN Dwg] AS HY_PN_Dwg, [Elec Dwg] AS Elec_Dwg, [Hy Dwg] AS Hy_Dwg, [Pn Dwg] AS Pn_Dwg FROM [oldjobs] WHERE ([Equipment Type] LIKE '%' + @Equipment_Type + '%')">
        <SelectParameters>
            <asp:ControlParameter ControlID="ewadeqddl" Name="Equipment_Type" PropertyName="SelectedValue" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:ScriptManager ID="ScriptManagerewade" runat="server">
    </asp:ScriptManager>
    <asp:GridView ID="GridViewwade" runat="server" AutoGenerateColumns="False" DataSourceID="eng2wadeds" CellPadding="4" HorizontalAlign="Center" ShowHeaderWhenEmpty="True" Width="100%" ForeColor="#333333" GridLines="None" AllowSorting="True">
